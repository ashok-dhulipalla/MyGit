...
public class BusinessGroupDaoImpl implements BusinessGroupDao{
	...
	@Override
	public List<BusinessGroupPOJO> getBusinessGroups(Connection con) throws SQLException
	{
		Connection newCon= con;
		PreparedStatement ps= null;
		List<BusinessGroupPOJO> grps= new ArrayList<>();
		ResultSet rs= null;
		if(newCon == null)
			newCon= DBConnection.getConnection();
